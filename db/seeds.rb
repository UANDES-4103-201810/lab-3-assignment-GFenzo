...
bought_tickets = BoughtTicket.create([{user_id: 1, ticket_id: 1, paid: true, bought_time: 0},
                                      ...
                                      {user_id: 1, ticket_id: 4, paid: true, bought_time: 0},
                                      {user_id: 2, ticket_id: 5, paid: false, bought_time: 0},
                                      {user_id: 4, ticket_id: 6, paid: true, bought_time: 0},
                                      {user_id: 3, ticket_id: 4, paid: false, bought_time: 0},
                                      {user_id: 5, ticket_id: 6, paid: true, bought_time: 0},
                                      {user_id: 1, ticket_id: 7, paid: true, bought_time: 0},
                                      {user_id: 2, ticket_id: 8, paid: false, bought_time: 0},
                                      {user_id: 4, ticket_id: 9, paid: true, bought_time: 0},
                                      {user_id: 3, ticket_id: 8, paid: false, bought_time: 0},
                                      {user_id: 5, ticket_id: 9, paid: true, bought_time: 0}])